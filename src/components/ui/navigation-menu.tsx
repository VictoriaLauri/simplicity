...
const navigationMenuContentBaseClass =
  "top-0 left-0 w-full p-2 pr-2.5 ease-[cubic-bezier(0.22,1,0.36,1)] md:absolute md:w-auto"

const navigationMenuContentViewportClass =
...
const navigationMenuContentMotionClass =
...
const navigationMenuContentFocusClass =
...
function NavigationMenuContent({
  ...
  return (
    <NavigationMenuPrimitive.Content
      ...
      className={cn(
        navigationMenuContentBaseClass,
        navigationMenuContentViewportClass,
        navigationMenuContentMotionClass,
        navigationMenuContentFocusClass,
        className
      )}
      {...props}
    />
